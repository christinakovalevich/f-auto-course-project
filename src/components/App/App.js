...
const getBenefitsPanelItems = () => {
    return [
        ...
        },
        {
            ...
            text: '60% клиентов возвращаются за второй покупкой, приводя своих знакомых и родственников.',
            img: benefitItemImg2
        },
        {
            id: 2,
            title: 'Самые доступные цены',
            text: 'Позволить наши автозапчасти может как начинающий автолюбитель, так и профессионал своего дела.',
            img: benefitItemImg3
        },
        {
            id: 3,
            title: 'Гарантия на все запчасти',
            text: 'Самый долгий срок гарантии на все двигатели внутреннего сгорания — целых 60 дней!',
            img: benefitItemImg4
        },
    ];
};
